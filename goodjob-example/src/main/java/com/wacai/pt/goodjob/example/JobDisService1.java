 ...
 */
public class JobDisService1 extends AbstractJobExecuteService {
  ...
  public void doExecute(ExecuteContext executeContext) throws Throwable {
    ...
    int i = (int) Math.round(Math.random() * 500);
    Thread.sleep(i * 1000L);
    if (i > 100 && i < 110){
      throw new Exception("JobDisService1 业务异常：" + i);
    }
    logger.info("JobDisService1 complete!");
  }
}
